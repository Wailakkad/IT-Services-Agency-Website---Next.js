    ...
    <section className="relative overflow-hidden bg-black text-white min-h-screen">
      ...
      <Link href="/" className="absolute left-6 top-6 z-20 group">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-blue-300 opacity-0 transition-opacity duration-300 group-hover:opacity-100">Back to Home</span>
        </div>
      </Link>

      {/* Background elements */}
      <div className="absolute inset-0 z-0">
        <div className="absolute -left-40 -top-40 h-80 w-80 rounded-full bg-blue-900/20 blur-3xl animate-pulse" style={{ animationDuration: '8s' }}></div>
        <div className="absolute right-0 top-1/3 h-60 w-60 rounded-full bg-blue-700/10 blur-3xl animate-pulse" style={{ animationDuration: '12s' }}></div>
        <div className="absolute bottom-0 left-1/3 h-40 w-60 rounded-full bg-blue-800/10 blur-3xl animate-pulse" style={{ animationDuration: '10s' }}></div>
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-20 md:px-8">
        <div className="mb-12 space-y-3">
          ...
          <p className="mx-auto max-w-3xl text-center text-base text-zinc-400 md:text-lg mt-2">
            Our maintenance packages ensure your site stays functional and healthy with regular updates, security checks, backups, and expert <strong className="text-white">support</strong>.
          </p>
        </div>
        
        <h3 className="mb-8 text-center text-2xl font-semibold text-white relative">
          <span className="inline-block transform transition-transform duration-500 hover:scale-105 hover:text-blue-200">🔧 Choose a Plan</span>
