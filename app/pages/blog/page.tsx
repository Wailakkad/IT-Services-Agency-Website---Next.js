...
import { ArrowRight, Code, Layout, Paintbrush, Search, Settings, MessageSquare, ChevronRight } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: "Professional websites that showcase your brand identity and core offerings with clarity and impact.",
      advantages: [
      ...
      businessValue: "Establish a professional online presence that builds credibility and attracts new clients 24/7, effectively serving as your digital storefront."
    },
    {
      title: "Landing Pages",
      icon: <Search className="mb-4 text-violet-300" size={32} />,
      description: "Conversion-focused pages designed to turn visitors into leads or customers through strategic design and compelling messaging.",
      advantages: [
      ...
      businessValue: "Maximize ROI on marketing campaigns by capturing and converting qualified leads with targeted, high-converting landing pages."
    },
    {
      title: "Branding Services",
      icon: <Paintbrush className="mb-4 text-violet-300" size={32} />,
      description: "Comprehensive brand identity development that communicates your company's values, personality, and unique selling propositions.",
      advantages: [
      ...
      businessValue: "Build brand recognition and customer loyalty by establishing a distinctive, professional identity that sets you apart from competitors."
    },
    {
      title: "UI/UX Design",
      icon: <MessageSquare className="mb-4 text-violet-300" size={32} />,
      description: "User-centered design that creates intuitive, enjoyable digital experiences while achieving your business objectives.",
      advantages: [
      ...
      businessValue: "Enhance customer satisfaction and retention with intuitive interfaces that make interaction with your digital products effortless and enjoyable."
    },
    {
      title: "Website Maintenance",
      icon: <Settings className="mb-4 text-violet-300" size={32} />,
      description: "Ongoing support, optimization, and updates that keep your website secure, fast, and aligned with evolving business needs.",
      advantages: [
      ...
      businessValue: "Protect your digital investment while continually improving performance, security, and user experience to maintain competitive advantage."
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-20 px-4 md:px-8 max-w-6xl mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mb-10">
            We build powerful digital experiences that elevate your brand, engage your audience, and drive measurable business results.
          </p>
      ...
      <section className="py-16 px-4 md:px-8 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4">Comprehensive Digital Services</h2>
          <p className="text-gray-300 max-w-2xl mx-auto">
            We offer end-to-end digital solutions designed to help businesses establish a strong online presence and achieve their growth objectives.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {services.map((service, index) => (
                <li key={index}>
                  ...
                  >
                    ...
                    <ChevronRight size={18} className={activeService === index ? 'text-violet-300' : 'text-gray-500'} />
                  </button>
                </li>
              ))}
            </ul>
          ...
          <div className="md:col-span-2 bg-gray-900 rounded-xl p-8">
            <div className="mb-6">
              ...
              <h3 className="text-2xl font-bold text-violet-300 mb-2">{services[activeService].title}</h3>
      ...
      <section className="py-16 px-4 md:px-8 bg-gray-950">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4">The Results We Deliver</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              We translate technical excellence into tangible business outcomes that drive growth and competitive advantage.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-900 p-6 rounded-xl">
              ...
              <p className="text-gray-300">
                Cutting-edge development practices and technologies that ensure scalable, maintainable, and future-proof digital solutions.
              </p>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-xl">
              ...
              <p className="text-gray-300">
                We align every digital initiative with your business objectives to ensure measurable ROI and meaningful impact.
              </p>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-xl">
              ...
              <p className="text-gray-300">
                Exceptional user experiences that delight your customers, increase engagement, and drive conversions.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="py-12 px-4 md:px-8 bg-gray-950">
        <div className="max-w-6xl mx-auto text-center text-gray-400">
          <p>© 2025 Your IT Services Agency. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
