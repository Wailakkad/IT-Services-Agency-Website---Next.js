      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-20 md:px-8">
        <div className="mb-12 space-y-3">
          ...
          <p className="mx-auto max-w-3xl text-center text-base text-zinc-400 md:text-lg mt-2">
            From simple one-screen pages to conversion-focused professional designs — we craft landing pages that <strong className="text-white">perform</strong>, not just look good.
          </p>
        </div>
        
        <h3 className="mb-8 text-center text-2xl font-semibold text-white relative">
          <span className="inline-block transform transition-transform duration-500 hover:scale-105 hover:text-violet-200">💼 Our Landing Page Packages</span>
